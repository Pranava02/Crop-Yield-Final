            ...
            <Card style={{ paddingLeft: '5%', paddingRight: '5%', borderRadius: '10%', paddingTop: '3%', paddingBottom: '3%', marginBottom: '3%' }}>
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    <label>
                        ...
                        <Select placeholder='Select Crop' type="text" value={crop} onChange={(e) => setcrop(e.target.value)}  issearchable={true}>
                            <option value='Arhar/Tur'>Arhar/Tur</option>
                            <option value='Bajra'>Bajra</option>
                            <option value='Castor seed'>Castor seed</option>
                            <option value='Other Cereals'>Cereals</option>
                            ...
                            <option value='Summer Pulses'>Summer Pulses</option>
                    ...
                    <label>
                        ...
                        <Select placeholder='Select Season' type="text" value={season} onChange={(e) => setseason(e.target.value)}>
